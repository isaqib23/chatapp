                    ...
                    <div class="col-md-3 mt-3">
                        <div class="card profile-card-5">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <p>
                                    <span class="badge badge-info">@if($value->id->kind == 'youtube#video') Video @else Channel @endif</span>
                                ...
                                @if($value->id->kind == 'youtube#video')
                                    <a href="{{url('/get_details?type=video&id=').$value->id->videoId}}" class="btn btn-primary">Details</a>
                                @else
                                    <a href="{{url('/get_details?type=channel&id=').$value->id->channelId}}" class="btn btn-primary">Details</a>
                                @endif
                            </div>
                        </div>
                    </div>
